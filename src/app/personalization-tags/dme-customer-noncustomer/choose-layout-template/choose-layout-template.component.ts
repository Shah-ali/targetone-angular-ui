...
@Component({
  selector: 'app-choose-layout-template',
  templateUrl: './choose-layout-template.component.html',
  styleUrls: ['./choose-layout-template.component.scss']
})
export class ChooseLayoutTemplateComponent implements OnInit {
