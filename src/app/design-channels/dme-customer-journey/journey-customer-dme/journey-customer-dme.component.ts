...
@Component({
  selector: 'app-journey-customer-dme',
  templateUrl: './journey-customer-dme.component.html',
  styleUrls: ['./journey-customer-dme.component.scss']
})
export class JourneyCustomerDMEComponent implements OnInit {
  ...
  loadDmeCustomerSelectedMethod(){
    this.shareService.isJourneyDMECustomerEditMode.subscribe((res:any) => {
  ...
  insertDmeCustomerRow(): void {
   ...
   if(this.multiArrayPath){
    dynamicTemplateInsert = "<dynamic-content id='"+uuid+"' type='dme' layout='"+layout+"' rowStyle='' layoutStyle='' modelName='" + this.selectedDmeDataObj.modelNameHash + "' modelDisplayName='" + this.selectedDmeDataObj.modelName + "' freeStyle='" +this.chooseLayoutSavedDataObj.freeStyle + "' maxCount='"+this.chooseLayoutSavedDataObj.maxCount+"' data-isDmeBlock='1'>";
    jsonObject = {
      "type": "dme",
    ...
    dynamicTemplateInsert = "<dynamic-content id='"+uuid+"' type='dme' modelName='" + this.selectedDmeDataObj.modelNameHash + "' modelDisplayName='" + this.selectedDmeDataObj.modelName + "' data-isDmeBlock='1'>";
    jsonObject = {
      "type": "dme",    
      "modelName":this.selectedDmeDataObj.modelName,
    };
