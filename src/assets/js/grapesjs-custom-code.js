 ...
 * Original file: /npm/grapesjs-custom-code@1.0.1/dist/index.js
 *
...
!function(e, t) {
    ...
    const d = function(e, t) {
        ...
        !function(e, t) {
            void 0 === t && (t = {});
            var s, a = e.Components, c = t.toolbarBtnCustomCode;
            a.addType('script', {
                view: {
                    onRender: function() {
                        var e = this.model
                    ...
                    onComponentsChange: function() {
                        ...
                        s = setTimeout((function() {
                            var n = e
                              ...
                              , r = n.el
                              , s = !0;
                            (i.get(o) || '').indexOf('<script') >= 0 && t.placeholderScript && (r.innerHTML = t.placeholderScript,
                            s = !1),
                            i.set({
                                droppable: s
                            })
        ...
        function(e, t) {
            ...
            e.Commands.add(i, a({
                ...
                run: function(e, t, o) {
                    ...
                    this.target = n,
                    (null == n ? void 0 : n.get('editable')) && this.showCustomCode(n, o)
                },
                stop: function(e) {
                    e.Modal.close()
                },
                ...
                getContent: function() {
                    ...
                    return o.className = "".concat(n, "custom-code"),
                ...
                getContentActions: function() {
                    ...
                    return n.innerHTML = t.buttonLabel,
