 ...
 * Original file: /npm/grapesjs-preset-webpage@1.0.2/dist/index.js
 *
...
!function(e, n) {
    ...
    var t = 'gjs-open-import-webpage'
      ...
      , a = 'set-device-mobile'
      , i = 'canvas-clear'
      , c = void 0 && (void 0).__assign || function() {
    ...
    const l = function(e, n) {
        ...
        l.add(t, function(e, n) {
            ...
            u.onclick = function(n) {
                e.Css.clear(),
                e.setComponents(d.getValue().trim()),
                r.close()
            }
            ,
            s.set(c({
    ...
    const u = function(e, n) {
        ...
        !function(e, n) {
            var t = function(t, o) {
                n.blocks.indexOf(t) >= 0 && e.Blocks.add(t, s(s({
                    select: !0,
                    category: 'Basic'
                }, o), n.block(t)))
            };
